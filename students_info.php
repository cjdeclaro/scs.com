      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4" style="text-align:right">
            <h3><a type="button" href="#deleterecord" data-toggle="modal" class="btn btn-danger">Delete Record</a></h3>
          </div>
        </div>

        <?php
          if(isset($_GET['message'])){
            if($_GET['message']=="password_doesnt_match"){
              echo'
                <div class="alert alert-warning alert-dismissable">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong>Oops!</strong> The password you entered does not match!
                </div>
              ';
            }else if($_GET['message']=="student_medical_added"){
              echo'
                <div class="alert alert-success alert-dismissable">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong>Success!</strong> Student Medical Added.
                </div>
              ';
            }else if($_GET['message']=="student_updated"){
              echo'
                <div class="alert alert-success alert-dismissable">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              ...
              echo'
                <div class="alert alert-danger alert-dismissable">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong>Oh Snap!</strong> Something went wrong. Please contact Tech Support :(
                </div>
              ';
            }
          }
        ...
        <div class="row">
          <div class="col-xs-12" style="text-align:right">
            <a type="button" href="students_update.php?id=<?php echo $studentnumber ?>" class="btn btn-info">
              Update Information
            </a>
            <a type="button" href="students_checkup.php?id=<?php echo $studentnumber ?>" class="btn btn-success">
              Add Medical Data
            </a>
          </div>
        </div>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Annual Dental Checkup</h4>
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  <thead class="cf">
                    <tr>
                  ...
                  <?php
                    ...
                    if(mysqli_num_rows($studentmedicalResult) > 0){
                      while($studentmedicalRow = mysqli_fetch_assoc($studentmedicalResult)){
                        ...
                        <tr>
                          <td data-title="Date">'.$studentmedicalRow['date'].'</td>
                          <td data-title="Time">'.$studentmedicalRow['time'].'</td>
                          <td data-title="Age">'.$studentmedicalRow['age'].'</td>
                          <td data-title="Weight">'.$studentmedicalRow['weight'].'</td>
                          <td data-title="Symptoms">
                            <a type="button" data-toggle="modal" href="#symptoms'.$count.'" class="btn btn-info btn-xs">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Annual Medical Checkup</h4>
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  <thead class="cf">
                    <tr>
